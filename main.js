...
while (true) {
  ...
  if (
    ...
    console.log(
      "Ops, ocorreu um erro. Uma letra foi encontrada ou o DIA de seu nascimento é inexistente."
    );
  }
}
...
while (true) {
  ...
  if (
    ...
    console.log(
      "Ops, ocorreu um erro. Uma letra foi encontrada ou seu ANO de nascimento é inexistente."
    );
  }
}
...
Data do evento: ${data_evento}`);
  ...
  fs.writeFile(
    "users_data.json",
    JSON.stringify(lista_de_participantes),
    (err) => {
      if (err) throw err;
